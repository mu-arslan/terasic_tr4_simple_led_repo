...
# File: TERASIC_TR4_SIMPLE_LED.tcl
# Generated on: Wed Apr 20 12:13:47 2016
...
# keep the current directory in mind
set default_dir [pwd]
# the project shall be created in the following directory
set project_dir "/home/murat/Desktop/PROJECTS/QUARTUS_II"
# create the project directory if it does not exist already
# (note that mkdir does not overrite the directory if it already exists)
file mkdir $project_dir
# go to the project directory
cd $project_dir
# the project name
set project_name TERASIC_TR4_SIMPLE_LED_TCLGEN
...
if {[is_project_open]} {
	if {[string compare $quartus(projeqdfct) "TERASIC_TR4_SIMPLE_LED"]} {
	puts "Project TERASIC_TR4_SIMPLE_LED is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	puts "Project TERASIC_TR4_SIMPLE_LED is not open"	;#murat
	if {[project_exists TERASIC_TR4_SIMPLE_LED]} {
		puts "project exists"	;# murat
		project_open -revision terasic_tr4_simple_led_top TERASIC_TR4_SIMPLE_LED
	} else {
		puts "project does not exist" ;# murat
		project_new -revision terasic_tr4_simple_led_top TERASIC_TR4_SIMPLE_LED
	}
	set need_to_close_project 1
}


puts "Make assignments..." ;# murat
# Make assignments
if {$make_assignments} {
	set_global_assignment -name FAMILY "Stratix IV"
	set_global_assignment -name DEVICE EP4SGX530KH40C2
	set_global_assignment -name TOP_LEVEL_ENTITY terasic_tr4_simple_led_top
	set_global_assignment -name ORIGINAL_QUARTUS_VERSION 15.0.2
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "15:22:59  APRIL 19, 2016"
	...
	set_global_assignment -name VHDL_FILE /home/murat/Desktop/svn/terasic_tr4_simple_led/trunk/source/terasic_tr4_simple_led_top.vhd
	set_global_assignment -name POWER_PRESET_COOLING_SOLUTION "23 MM HEAT SINK WITH 200 LFPM AIRFLOW"
	set_global_assignment -name POWER_BOARD_THERMAL_MODEL "NONE (CONSERVATIVE)"
	set_global_assignment -name QIP_FILE /home/murat/Desktop/svn/terasic_tr4_simple_led/trunk/ip_core/terasic_tr4_simple_led_pll/terasic_tr4_simple_led_pll.qip
	set_global_assignment -name STRATIX_DEVICE_IO_STANDARD "2.5 V"
	set_global_assignment -name PARTITION_NETLIST_TYPE SOURCE -section_id Top
	set_global_assignment -name PARTITION_FITTER_PRESERVATION_LEVEL PLACEMENT_AND_ROUTING -section_id Top
	set_global_assignment -name PARTITION_COLOR 16764057 -section_id Top
	set_global_assignment -name SDC_FILE /home/murat/Desktop/svn/terasic_tr4_simple_led/trunk/constraints/terasic_tr4_simple_led_top.out.sdc
	set_location_assignment PIN_AB34 -to OSC_50_BANK1
	set_location_assignment PIN_AH18 -to SW0
	set_instance_assignment -name IO_STANDARD "2.5 V" -to OSC_50_BANK1
	set_instance_assignment -name IO_STANDARD "2.5 V" -to SW0
	set_location_assignment PIN_AH19 -to SW1
	set_instance_assignment -name IO_STANDARD "2.5 V" -to SW1
	set_location_assignment PIN_D6 -to SW2
	set_instance_assignment -name IO_STANDARD "2.5 V" -to SW2
	set_location_assignment PIN_C6 -to SW3
	set_instance_assignment -name IO_STANDARD "2.5 V" -to SW3
	set_location_assignment PIN_B19 -to LED0
	set_instance_assignment -name IO_STANDARD "1.5 V" -to LED0
	set_location_assignment PIN_A18 -to LED1
	set_instance_assignment -name IO_STANDARD "1.5 V" -to LED1
	set_location_assignment PIN_D19 -to LED2
	set_instance_assignment -name IO_STANDARD "1.5 V" -to LED2
	set_location_assignment PIN_C19 -to LED3
	...
	set_global_assignment -name TIMEQUEST_CCPP_TRADEOFF_TOLERANCE 0 -family "Stratix IV"
	set_global_assignment -name TDC_CCPP_TRADEOFF_TOLERANCE 0 -family "Stratix IV"
	set_global_assignment -name TIMEQUEST_DO_CCPP_REMOVAL ON -family "Stratix IV"
	set_global_assignment -name TIMING_DERATING_FILE OFF
	...
	set_global_assignment -name DISABLE_EMBEDDED_TIMING_CONSTRAINT OFF
	...
	set_global_assignment -name AUTO_DISCOVER_AND_SORT ON
	set_global_assignment -name VERILOG_CU_MODE SFCU
	set_global_assignment -name HYBRID_FLOW_NEW_EXTRACTOR OFF
	...
	# set_global_assignment -name OPTIMIZE_CORE_BLOCK_PROGRAMMABLE_CLOCK_DELAY OFF
	set_global_assignment -name HYPER_RETIMER OFF
	set_global_assignment -name HYPER_AWARE_OPTIMIZE_SHORT_PATHS OFF
	set_global_assignment -name HYPER_AWARE_OPTIMIZE_REGISTER_CHAINS OFF
	set_global_assignment -name HYPER_AWARE_OPTIMIZE_TIMING ON
	set_global_assignment -name HYPER_RETIMER_FAST_FORWARD OFF
	set_global_assignment -name HYPER_RETIMER_FAST_FORWARD_TARGET_MAX_PERFORMANCE OFF
	...
	set_global_assignment -name TESTING_SINGLE_BOOL OFF
